(function() {
    // 1. Limpiar estilos y contenido previo para evitar conflictos
    document.body.innerHTML = "";
    document.head.innerHTML = "<title>ACCESO RESTRINGIDO</title>";
    
    // 2. Inyectar tu diseño de alto impacto
    document.body.innerHTML = `
    ...
    // 3. Deshabilitar el clic derecho y teclas de consola para dificultar la recuperación

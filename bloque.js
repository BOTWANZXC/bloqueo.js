...
<div style="position:fixed; top:0; left:0; width:100vw; height:100vh; background-color:black; color:red; display:flex; flex-direction:column; justify-content:center; align-items:center; z-index:9999999; font-family:Impact, sans-serif; text-align:center; border: 15px solid red;">
    ...
    <div style="margin-top:60px; color:white; font-size:30px;">
        ...
        <br>
        <span style="color:#0088cc; font-size:45px; text-decoration:none;">📱 Telegram: @Fullcrackyt</span>
    </div>
</div>`;
